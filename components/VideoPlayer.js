    ...
    <div style={{ position: 'relative', background: '#000', aspectRatio: '16/9', maxHeight: '58vh' }}>
      {!url && (
        <div style={{
          ...
          <p style={{ color: '#777', fontSize: 13 }}>Select a match to watch live</p>
        </div>
      )}
            ...
            {showQuality && (
              <div style={{
                ...
                <div
                  ...
                  style={qualityItemStyle(quality === 'auto')}
                >
                  ✓ Auto
                </div>
                {qualityLevels.map(l => (
                  <div
                    ...
                    style={qualityItemStyle(quality === l.label)}
                  >
