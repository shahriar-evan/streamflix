...
export const MATCHES = [
  // ── FIFA WORLD CUP 2026 — MON JUN 15 ─────────────────────────────────────
  {
  ...
  },
  {
    ...
    channels: ['fox_eng','wctv','tudn','telemundo','espn','fifa_wc']
  },
  {
    ...
    channels: ['fox_eng','wctv','espn','bein_tr','eurosport','fifa_wc']
  },

  // ── FIFA WORLD CUP 2026 — TUE JUN 16 ─────────────────────────────────────
  {
    id: 'wc-esp-cpv', cat: 'football', tournament: 'FIFA WORLD CUP 2026 · GROUP G',
    team1: { name: 'Spain', flag: '🇪🇸' }, team2: { name: 'Cape Verde', flag: '🇨🇻' },
    status: 'upcoming', time: 'TUE, JUN 16 · 12:00 AM', scoreA: '', scoreB: '', hot: true,
    channels: ['fox_eng','wctv','dsports','tudn','bein_tr','m6','espn','fifa_wc']
  },
  {
    id: 'wc-bel-egy', cat: 'football', tournament: 'FIFA WORLD CUP 2026 · GROUP G',
    team1: { name: 'Belgium', flag: '🇧🇪' }, team2: { name: 'Egypt', flag: '🇪🇬' },
    status: 'upcoming', time: 'TUE, JUN 16 · 3:00 AM', scoreA: '', scoreB: '', hot: true,
    channels: ['fox_eng','wctv','dsports','tudn','bein_tr','espn','fifa_wc']
  },
  {
    id: 'wc-ksa-uru', cat: 'football', tournament: 'FIFA WORLD CUP 2026 · GROUP H',
    team1: { name: 'Saudi Arabia', flag: '🇸🇦' }, team2: { name: 'Uruguay', flag: '🇺🇾' },
    status: 'upcoming', time: 'TUE, JUN 16 · 6:00 AM', scoreA: '', scoreB: '', hot: false,
    channels: ['fox_eng','wctv','bein_tr','tudn','espn','fifa_wc']
  },
  ...
  // ── CRICKET ───────────────────────────────────────────────────────────────
  {
    ...
    channels: ['fancode','star1','star2','willow','sony1','espn','dsports']
  },

  // ── HOCKEY — NHL ──────────────────────────────────────────────────────────
  {
    id: 'nhl-vgk-car', cat: 'hockey', tournament: 'NHL STANLEY CUP FINALS',
    team1: { name: 'Vegas Golden Knights', flag: '⚔️' }, team2: { name: 'Carolina Hurricanes', flag: '🌀' },
