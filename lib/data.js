...
export const WC_CHANNELS = [
  ...
  // ─── Fancode (Cricket) ────────────────────────────────────────────────────
  {
    ...
    servers: [
      { label: 'Fancode S1', url: p('https://crickethls.fancode.com/live/fancode/master.m3u8') },
      { label: 'Fancode S2', url: p('https://live.fancode.com/hls/live/fancode_cricket.m3u8') },
...
export const MATCHES = [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    channels: ['star1', 'star2', 'willow', 'sony1', 'sony2', 'espn', 'bein', 'dsports', 'tensports']
  },
  {
    ...
    channels: ['star1', 'star2', 'willow', 'sony1', 'espn', 'dsports', 'tensports']
  },
  {
    id: 'cr-ban-aus', cat: 'cricket', tournament: 'ODI SERIES · BAN vs AUS',
    team1: { name: 'Bangladesh', flag: '🇧🇩' }, team2: { name: 'Australia', flag: '🇦🇺' },
    status: 'live', time: 'LIVE', scoreA: '160/3', scoreB: '', hot: true,
    channels: ['fancode', 'tsports', 'bangla_fifa', 'star1', 'willow', 'sony2', 'espn', 'dsports']
  },
  {
    ...
    channels: ['tsports', 'bangla_fifa', 'star1', 'willow', 'sony3', 'espn']
  },
  {
  ...
  // ═══════════════════════════════════════════
  {
    ...
    channels: ['espn', 'dazn', 'dazncombat', 'tnt']
  },
  {
  ...
  // ═══════════════════════════════════════════
  {
    ...
    channels: ['f1tv', 'dazn', 'redbull', 'eurosport']
  },
];
