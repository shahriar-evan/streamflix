...
export const WC_CHANNELS = [
  ...
  },
  {
    ...
    servers: [
      { label: 'ESPN4 LAT',  url: p('http://181.191.141.7/Live/51334cbb88db0e050c59ef2d28c53491/local-espn4lat_720.m3u8') },
  ...
  // ─── Win Sports ───────────────────────────────────────────────────────────
  {
    ...
    servers: [
      ...
      { label: 'Win+ S5',   url: p('http://m3u.tvcluboficial.com/m/m/1042.m3u8') },
    ]
  },
  ...
  // ─── Fox Sports ─────────────────────────────────────────────────────────
  {
    ...
    servers: [
      ...
      { label: 'FOX S5',    url: p('http://45.5.119.43:4000/play/a024/index.m3u8') },
    ]
  },
  ...
  // ─── beIN Sports ──────────────────────────────────────────────────────────
  {
    ...
    servers: [
      ...
      { label: 'beIN FR1',  url: p('http://99.27.51.147:8080/BeinSport/index.m3u8') },
      { label: 'beIN FR3',  url: p('http://99.27.51.147:8080/BeinSport3/index.m3u8') },
      { label: 'beIN AU1',  url: p('https://wahyu1ptv.pages.dev/AstroBein2.m3u8') },
  ...
  // ─── TUDN ─────────────────────────────────────────────────────────────────
  {
    ...
    servers: [
      ...
      { label: 'TUDN HD',   url: p('https://tv.topmediatv.net:25463/live/TopMediaWeb/bOteTR8ED1/128.m3u8') },
      ...
      { label: 'TUDN S5',   url: p('http://200.229.147.142:8000/play/a096/index.m3u8') },
    ]
  },
  ...
  // ─── Telemundo / NBC ──────────────────────────────────────────────────────
  {
    ...
    servers: [
      ...
      { label: 'NBC Univ',  url: p('http://190.11.225.124:5000/live/universo_hd/playlist.m3u8') },
    ]
  },
  ...
  // ─── FIFA WORLDCUP 2026 ───────────────────────────────────────────────────
  {
    ...
    servers: [
      ...
      { label: 'WC TV ENG', url: p('https://nbculocallive.akamaized.net/hls/live/2037499/puertorico/stream1/master.m3u8') },
      { label: 'TUDN USA',  url: p('http://m3u.tvcluboficial.com/m/m/957.m3u8') },
  ...
  // ─── Bangla FIFA 2026 ─────────────────────────────────────────────────────
  {
    ...
    servers: [
      { label: 'T Sports',  url: p('https://bss-hls.akamaized.net/hls/live/2093056/tsports/index.m3u8') },
      { label: 'T Sports2', url: p('http://103.145.15.99:8080/tsports/live.m3u8') },
    ]
  },
